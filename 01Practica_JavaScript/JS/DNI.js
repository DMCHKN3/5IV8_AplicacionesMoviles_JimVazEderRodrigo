const verificar = document.getElementById('btn-verificar');
...
function validacionDNI() {
    const numDNI = document.getElementById('txt-numDNI').value;
    const letraDNI = document.getElementById('txt-letraDNI').value.toUpperCase();
